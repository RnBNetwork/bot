// oltService.js - FINAL CLEAN VERSION (NO BASIC AUTH, DOUBLE LOGIN FIX)
...
// 3. Hioso (Puppeteer) - DOUBLE LOGIN WEB FORM FIX
async function cekRedamanHioso(oltConfig, mac) {
    ...
    try {
        ...
        // ❌ TIDAK ADA page.authenticate() DI SINI!
        // OLT Hioso menggunakan Web Form Login 2x, bukan HTTP Basic Auth.
        ...
        // FASE LOGIN PERTAMA
        if (await page.$('#a')) {
            console.log(`   🔑 Mengisi form login pertama...`);
        ...
        try {
            ...
            console.log(`   ✅ Login sukses, masuk ke halaman aman data.`);
        }

        // FASE EKSTRAKSI DATA
        if (oltConfig.iframe) {
            console.log(`   Mode: Iframe`);
